...
:mod:`tastet.plotting._panel` and are shared with
:mod:`tastet.plotting.heatmap`.
...
from tastet.distance import pairwise_distances, D_MAX
...
def plot_grid_histograms(
    ...
    *,
    ...
    are built by :func:`tastet.plotting._panel.panel_title`.
