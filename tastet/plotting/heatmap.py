...
from tastet.plotting._panel import panel_title as _panel_title
from tastet.plotting.style import set_mpl_style, savefig, cmap as project_cmap
...
# tastet.plotting._panel.soap_label, so heatmap axes and histogram
