"""Plotting helpers for SADS analyses.

Move your existing style functions (``set_mpl_style``, ``apply_axis_style``,
``savefig``, ``cmap``) from ``utils/plot_utils.py`` into this module.
"""
...
from sads.plot_style import set_mpl_style, apply_axis_style, savefig, cmap
...
def plot_kpca(
    ...
    **scatter_kw
    ...
    (Figure, Axes)
    """
    from sads.kpca import KPCAResult  # deferred to avoid circular import at module level
